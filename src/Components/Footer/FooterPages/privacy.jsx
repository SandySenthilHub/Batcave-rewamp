...
function PrivacyPolicy() {
    ...
    return (
        <>
            ...
            <div className='container-fluid PrivacyContainer'>
            ...
            <div className="page-back-nav" onClick={navigateBack}>
                ...
                <div className='row PrivacyContent'>
                    ...
                    <div>Interpretation and Definitions</div>  {/* 5  */}
                    <div>Interpretation</div> {/* 6  */}
                    ...
                    <ul>
                        ...
                        <li> <b>Company </b>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Invicious Automotive (P) Ltd., 28/1, Fourth Floor, Arima Wakefield, Avinashi Road, Peelamedu, Coimbatore - 641004.</li>
                        ...
                        <li> <b>Website</b> refers to Batcave, accessible from <a href='https://www.batcave.club'>https://www.batcave.club</a></li>
                    ...
                    <div>Collecting and Using Your Personal Data</div> {/* 11  */}
                    ...
                    <div>Information from Third-Party Social Media Services</div>   {/* 21 */}

                    <div>The Company allows You to create an account and log in to use the Service through the following Third-party Social Media Services:</div>
                    <ul>
                        <li>Google</li>
                        <li>Facebook</li>
                        <li>Instagram</li>
                    ...
                    <div>If You decide to register through or otherwise grant us access to a Third-Party Social Media Service, We may collect Personal data that is already associated with Your Third-Party Social Media Service's account, such as Your name, Your email address, Your activities or Your contact list associated with that account.</div>
                    <div>You may also have the option of sharing additional information with the Company through Your Third-Party Social Media Service's account. If You choose to provide such information and Personal Data, during registration or otherwise, You are giving the Company permission to use, share, and store it in a manner consistent with this Privacy Policy.</div>


                    <div>Tracking Technologies and Cookies</div>  {/* 26 */}
                    ...
                    <div>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. </div>
                    ...
                    <div>Use of Your Personal Data</div>  {/* 33 */}
                    ...
                    <div>We may share Your personal information in the following situations:</div> {/* 36 */}
                    ...
                    <div>Retention of Your Personal Data</div>  {/* 38 */}
                    ...
                    <div>Transfer of Your Personal Data</div>  {/* 41 */}
                    ...
                    <div>Delete Your Personal Data</div>  {/* 45 */}
                    ...
                    <div>Disclosure of Your Personal Data</div>  {/* 50 */}
                    <div>Business Transactions</div> {/* 51 */}
                    ...
                    <div>Other legal requirements</div> {/* 55 */}
                    ...
                    <div>Security of Your Personal Data</div> {/* 58 */}
                    ...
                    <div>Links to Other Websites</div> {/* 63 */}
                    ...
                    <div>Changes to this Privacy Policy</div>   {/* 66 */}
